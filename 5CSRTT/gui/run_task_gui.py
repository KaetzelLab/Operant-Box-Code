...
class MainGui(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.loadmilk.clicked.connect(lambda: self.setup_task_milk())
        self.cleantube.clicked.connect(lambda: self.setup_task_clean())
        ...
        self.pushButton_setupselect_1.clicked.connect(lambda: self.select_setup_1())
        self.pushButton_setupselect_2.clicked.connect(lambda: self.select_setup_2())
        self.pushButton_setupselect_3.clicked.connect(lambda: self.select_setup_3())
    ...
    def select_setup_1(self):
        ...
        self.pushButton_setupselect_1.setText('SetUp : 01 [Box 01 - Box 08]')
        ...
        self.comboBox_srport_1.setCurrentText('com4')
        self.comboBox_srport_2.setCurrentText('com5')
    ...
    def select_setup_2(self):
        self.pushButton_setupselect_1.setEnabled(False)
        self.pushButton_setupselect_2.setText('SetUp : 02 [Box 09 - Box 16]')
        self.pushButton_setupselect_1.setStyleSheet('Setup_1')
        self.pushButton_setupselect_2.setStyleSheet('Setup_2')
        self.pushButton_setupselect_3.setStyleSheet('Setup_3')
        self.pushButton_setupselect_2.setEnabled(False)
        ...
        self.tableWidget.setItem(2, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 9')))
        self.tableWidget.setItem(3, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 10')))
        self.tableWidget.setItem(4, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 11')))
        self.tableWidget.setItem(5, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 12')))
        self.tableWidget.setItem(6, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 13')))
        self.tableWidget.setItem(7, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 14')))
        self.tableWidget.setItem(8, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 15')))
        self.tableWidget.setItem(9, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 16')))
    ...
    def select_setup_3(self):
        self.pushButton_setupselect_1.setEnabled(False)
        self.pushButton_setupselect_3.setText('SetUp : 03 [Box 17 - Box 24]')
        self.pushButton_setupselect_2.setEnabled(False)
        self.pushButton_setupselect_3.setEnabled(False)
        self.pushButton_setupselect_1.setStyleSheet('Setup_1')
        self.pushButton_setupselect_2.setStyleSheet('Setup_2')
        ...
        self.comboBox_srport_5.setCurrentText('com34')
        #self.comboBox_srport_6.setCurrentText('com18')
        #self.comboBox_srport_7.setCurrentText('com19')
        #self.comboBox_srport_8.setCurrentText('com20')
        self.tableWidget.setItem(2, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 17')))
        self.tableWidget.setItem(3, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 18')))
        self.tableWidget.setItem(4, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 19')))
        self.tableWidget.setItem(5, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 20')))
        self.tableWidget.setItem(6, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 21')))
        self.tableWidget.setItem(7, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 22')))
        self.tableWidget.setItem(8, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 23')))
        self.tableWidget.setItem(9, 1,
                                 QtWidgets.QTableWidgetItem(str('Box 24')))
    ...
    def disable_widgets(self):
        ...
        self.cleantube.setEnabled(False)
        self.loadmilk.setEnabled(False)
    ...
    def connect_1(self):
        try:
            ...
            self.cleantube.setEnabled(True)
            self.loadmilk.setEnabled(True)
    ...
    def disconnect_all(self):
        try:
            ...
            self.pushButton_Connect_all.setText('Connect_all')
    ...
    def setup_task_clean(self):
        if self.connected_1:
            try:
                self.comboBox_task1.setCurrentText("Z_Clean_tube")
                task_1 = self.comboBox_task1.currentText()
                if self.uploaded_1:
                    self.lineEdit_status_1.setText('Resetting task..')
                else:
        ...
        if self.connected_2:
            try:
                self.comboBox_task2.setCurrentText("Z_Clean_tube")
                task_2 = self.comboBox_task2.currentText()
                if self.uploaded_2:
                    self.lineEdit_status_2.setText('Resetting task..')
                else:
        ...
        if self.connected_3:
            try:
                self.comboBox_task3.setCurrentText("Z_Clean_tube")
                task_3 = self.comboBox_task3.currentText()
                if self.uploaded_3:
                    self.lineEdit_status_3.setText('Resetting task..')
                else:
        ...
        if self.connected_4:
            try:
                self.comboBox_task4.setCurrentText("Z_Clean_tube")
                task_4 = self.comboBox_task4.currentText()
                if self.uploaded_4:
                    self.lineEdit_status_4.setText('Resetting task..')
                else:
        ...
        if self.connected_5:
            try:
                self.comboBox_task5.setCurrentText("Z_Clean_tube")
                task_5 = self.comboBox_task5.currentText()
                if self.uploaded_5:
                    self.lineEdit_status_5.setText('Resetting task..')
                else:
        ...
        if self.connected_6:
            try:
                self.comboBox_task6.setCurrentText("Z_Clean_tube")
                task_6 = self.comboBox_task6.currentText()
                if self.uploaded_6:
                    self.lineEdit_status_6.setText('Resetting task..')
                else:
        ...
        if self.connected_7:
            try:
                self.comboBox_task7.setCurrentText("Z_Clean_tube")
                task_7 = self.comboBox_task7.currentText()
                if self.uploaded_7:
                    self.lineEdit_status_7.setText('Resetting task..')
                else:
        ...
        if self.connected_8:
            try:
                self.comboBox_task8.setCurrentText("Z_Clean_tube")
                task_8 = self.comboBox_task8.currentText()
                if self.uploaded_8:
                    self.lineEdit_status_8.setText('Resetting task..')
                else:
    ...
    def setup_task_milk(self):
        if self.connected_1:
            try:
                self.comboBox_task1.setCurrentText("Z_Load_milk")
                task_1 = self.comboBox_task1.currentText()
                if self.uploaded_1:
                    self.lineEdit_status_1.setText('Resetting task..')
                else:
        ...
        if self.connected_2:
            try:
                self.comboBox_task2.setCurrentText("Z_Load_milk")
                task_2 = self.comboBox_task2.currentText()
                if self.uploaded_2:
                    self.lineEdit_status_2.setText('Resetting task..')
                else:
        ...
        if self.connected_3:
            try:
                self.comboBox_task3.setCurrentText("Z_Load_milk")
                task_3 = self.comboBox_task3.currentText()
                if self.uploaded_3:
                    self.lineEdit_status_3.setText('Resetting task..')
                else:
        ...
        if self.connected_4:
            try:
                self.comboBox_task4.setCurrentText("Z_Load_milk")
                task_4 = self.comboBox_task4.currentText()
                if self.uploaded_4:
                    self.lineEdit_status_4.setText('Resetting task..')
                else:
        ...
        if self.connected_5:
            try:
                self.comboBox_task5.setCurrentText("Z_Load_milk")
                task_5 = self.comboBox_task5.currentText()
                if self.uploaded_5:
                    self.lineEdit_status_5.setText('Resetting task..')
                else:
        ...
        if self.connected_6:
            try:
                self.comboBox_task6.setCurrentText("Z_Load_milk")
                task_6 = self.comboBox_task6.currentText()
                if self.uploaded_6:
                    self.lineEdit_status_6.setText('Resetting task..')
                else:
        ...
        if self.connected_7:
            try:
                self.comboBox_task7.setCurrentText("Z_Load_milk")
                task_7 = self.comboBox_task7.currentText()
                if self.uploaded_7:
                    self.lineEdit_status_7.setText('Resetting task..')
                else:
        ...
        if self.connected_8:
            try:
                self.comboBox_task8.setCurrentText("Z_Load_milk")
                task_8 = self.comboBox_task8.currentText()
                if self.uploaded_8:
                    self.lineEdit_status_8.setText('Resetting task..')
                else:
    ...
    def record_task_all(self):
        try:
            if self.test_data_path_1():
                ...
                self.pushButton.clicked.setEnabled(False)
                self.pushButton_Stop1.setEnabled(True)
                self.pushButton_connect_1.setEnabled(False)
                self.lineEdit_subid1.setEnabled(True)
                print('\nRun started at: {}\n'.format(datetime.now().strftime('%Y/%m/%d %H:%M:%S')))
    ...
    def stop_task_all(self, error=False, stopped_by_task=False):
        try:
            self.process_timer_1.stop()
            self.refresh_timer_1.start(self.refresh_interval)
            if not (error or stopped_by_task):
    ...
    def process_data_1(self):
        ...
        try:
            ...
            self.lcdNumber.display(run_time_1)
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(6, 7,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_response_5)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 32,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_list_5)))
                            self.correct_time_start_5 = time.time()
                            self.tableWidget.setItem(6, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_time_start_5)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(6, 33,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_list_5)))
                        ...
                        self.tableWidget.setItem(6, 12,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_response_5)))
                        try:
                            ...
                            self.tableWidget.setItem(6, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.premature_latency_cv_list_5)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(6, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_latancy_cv_list_5)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(6, 10,
                                                 QtWidgets.QTableWidgetItem(str(self.Choice_state_5)))
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(7, 7,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_response_6)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 32,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_list_6)))
                            self.correct_time_start_6 = time.time()
                            self.tableWidget.setItem(7, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_time_start_6)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(7, 33,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_list_6)))
                        ...
                        self.tableWidget.setItem(7, 12,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_response_6)))
                        try:
                            ...
                            self.tableWidget.setItem(7, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.premature_latency_cv_list_6)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(7, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_latancy_cv_list_6)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(7, 10,
                                                 QtWidgets.QTableWidgetItem(str(self.Choice_state_6)))
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(8, 7,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_response_7)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 32,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_list_7)))
                            self.correct_time_start_7 = time.time()
                            self.tableWidget.setItem(8, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_time_start_7)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(8, 33,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_list_7)))
                        ...
                        self.tableWidget.setItem(8, 12,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_response_7)))
                        try:
                            ...
                            self.tableWidget.setItem(8, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.premature_latency_cv_list_7)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(8, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_latancy_cv_list_7)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(8, 10,
                                                 QtWidgets.QTableWidgetItem(str(self.Choice_state_7)))
                ...
                for string in value:
                    ...
                    if "Sample_state" in str(string):
                        ...
                        self.tableWidget.setItem(9, 7,
                                                 QtWidgets.QTableWidgetItem(str(self.Correct_response_8)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 32,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_cv_list_8)))
                            self.correct_time_start_8 = time.time()
                            self.tableWidget.setItem(9, 62,
                                                     QtWidgets.QTableWidgetItem(str(self.correct_time_start_8)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(9, 33,
                                                     QtWidgets.QTableWidgetItem(str(self.incorrect_cv_list_8)))
                        ...
                        self.tableWidget.setItem(9, 12,
                                                 QtWidgets.QTableWidgetItem(str(self.Premature_response_8)))
                        try:
                            ...
                            self.tableWidget.setItem(9, 34,
                                                     QtWidgets.QTableWidgetItem(str(self.premature_latency_cv_list_8)))
                        ...
                        try:
                            ...
                            self.tableWidget.setItem(9, 35,
                                                     QtWidgets.QTableWidgetItem(str(self.reward_latancy_cv_list_8)))
                    ...
                    try:
                        ...
                        self.tableWidget.setItem(9, 10,
                                                 QtWidgets.QTableWidgetItem(str(self.Choice_state_8)))
