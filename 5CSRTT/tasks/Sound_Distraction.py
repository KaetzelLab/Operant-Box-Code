#--------------------------5-CSRTT Sound Distraction Protocol Task File----------------------

# cue presentation ==> Correct response       ==> reward(@reward port)      ==> iti(Sound Distraction)** ==> cue presentation
# cue presentation ==> Incorrect response     ==> penalty (house light off) ==> iti(Sound Distraction)** ==> cue presentation
# cue presentation ==> omission (no response) ==> penalty (house light off) ==> iti(Sound Distraction)** ==> cue presentation
...
# programme randomnly presents white noise during iti and sound level, type of sound need to be changed according to experiment
...
v.target        = 0
v.dis_dur       = 0            # variable initiation for sound dis duration
